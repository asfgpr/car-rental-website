...
<title>Dream Self Car Drive | Contact Us</title>
<!--Bootstrap -->
...
{ ?>
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:+91<?php   echo htmlentities($result->ContactNo); ?>">+91-<?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
            <li>

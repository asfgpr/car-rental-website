...
<head>
	...
	<title>Dream Self Car Drive | Admin Dashboard</title>
...
<body>
	<div class="hidden">
		...
		<div class="col-md-3 sample-box">
			<div class="panel panel-default">
				<div class="panel-body bk-danger text-light">
					<div class="stat-panel text-center">
						<div class="stat-panel-number h1 boxheading">0</div>
						<div class="stat-panel-title text-uppercase boxtitle">test</div>
					</div>
				</div>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row appendbox">
									
<?php 
$sql11 ="SELECT id from tblbooking where Status = '0' ";
$query11= $dbh -> prepare($sql11);
$query11->execute();
$results11=$query11->fetchAll(PDO::FETCH_OBJ);
$newbookings=$query11->rowCount();
if($newbookings){
?>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-danger text-light">
												<div class="stat-panel text-center">
													<div class="stat-panel-number h1 "><?php echo htmlentities($newbookings);?></div>
													<div class="stat-panel-title text-uppercase">NEW BOOKING</div>
												</div>
											</div>
											<a href="manage-new-bookings.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
<?php
 } 
$sq22 ="SELECT id from tblcontactusquery where status is NULL ";
$quer22= $dbh -> prepare($sq22);
$quer22->execute();
$result22=$quer22->fetchAll(PDO::FETCH_OBJ);
$newquery=$quer22->rowCount();
if($newquery){
 ?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-danger text-light">
												<div class="stat-panel text-center">
													<div class="stat-panel-number h1 "><?php echo htmlentities($newquery);?></div>
													<div class="stat-panel-title text-uppercase">NEW QUERIES</div>
												</div>
											</div>
											<a href="manage-new-conactusquery.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
<?php
 } 
$sql33 ="SELECT id from tbltestimonial where status is NULL or status = '0'";
$query33= $dbh -> prepare($sql33);
$query33->execute();
$results33=$query33->fetchAll(PDO::FETCH_OBJ);
$newtestimonials=$query33->rowCount();
if($newtestimonials){
 ?>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-danger text-light">
												<div class="stat-panel text-center">
													<div class="stat-panel-number h1 "><?php echo htmlentities($newtestimonials);?></div>
													<div class="stat-panel-title text-uppercase">INACTIVE TESTIMONIAL</div>
												</div>
											</div>
											<a href="new_testimonials.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
<?php } ?>
